intellisense.annotate(jQuery, {
  ...
  'browser': function() {
    /// <summary>Contains flags for the u¿ytkownikagent, read from navigator.u¿ytkownikagent. We recommend against using this property; please try to use feature detection instead (see jQuery.support). jQuery.browser may be moved to a plugin in a future release of jQuery.</summary>
    /// <returns type="Map" />
  },
